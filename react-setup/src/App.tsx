    ...
    <Router>
      <div className="app">
        <Routes>
          ...
          <Route
            path="/All-lecturers"
            element={<CreateLecturer userType="Lecturer" />}
          />
          <Route path="/list-student-lecturer" element={<ListOfStudents />} />
          <Route
            path="/"
            element={<AllLecturer userType="Lecturer" path="/CreateLecturer" />}
          />
          <Route
            path="/CreateLecturer"
            element={<CreateLecturer userType="Lecturer" />}
          ...
          <Route
            path="/:id/list-of-pendingStudents"
            element={<ListOfPendingStudents />}
          />
          <Route
            path="/:id/list-of-selfstudy-students"
            element={
              <ListOfSelfStudyOROverloadStudents activeItem="List of self study" />
            }
          />
          <Route
            path="/:id/list-of-overload-students"
            element={
              <ListOfSelfStudyOROverloadStudents activeItem="List of overload" />
            }
          />
          <Route
            path="/CreateDoctor"
            element={<CreateLecturer userType="Doctor" />}
          />
          <Route
            path="/Doctors"
            element={<AllLecturer userType="Doctor" path="/CreateDoctor" />}
          />
