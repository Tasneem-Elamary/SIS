...
const PendingSchedule = ({ getAllSchedules }: AllSchedulesProps) => {
    ...
    return (
        <div className="container555">
            <RegistrationNavbar />
            <StudentNavlBar activeItem="Pending Schedule" />
...
const mapDispatchToProps = (dispatch: Dispatch) => {
    return bindActionCreators(
        {
            getAllSchedules: studentAction.getPendingScheduleAction,
        },
        dispatch
    );
};

export default connect(null, mapDispatchToProps)(PendingSchedule);
